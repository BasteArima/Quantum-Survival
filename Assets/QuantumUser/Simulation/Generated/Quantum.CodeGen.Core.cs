...
namespace Quantum {
  ...
  public unsafe partial struct Bullet : Quantum.IComponent {
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + DestroyOnHit.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (Bullet*)ptr;
        QBoolean.Serialize(&p->DestroyOnHit, serializer);
  ...
  public unsafe partial struct Enemy : Quantum.IComponent {
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 11071;
        hash = hash * 31 + DamagePerSecond.GetHashCode();
        hash = hash * 31 + AttackRange.GetHashCode();
        hash = hash * 31 + DamageAccumulator.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        FP.Serialize(&p->DamageAccumulator, serializer);
        FP.Serialize(&p->DamagePerSecond, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct FlowFieldData : Quantum.IComponentSingleton {
    public const Int32 SIZE = 2568;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    public fixed Byte Grid[2500];
    [FieldOffset(2544)]
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 10723;
        fixed (Byte* p = Grid) hash = hash * 31 + HashCodeUtils.GetArrayHashCode(p, 2500);
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (FlowFieldData*)ptr;
        serializer.Stream.SerializeBuffer(&p->Grid[0], 2500);
        serializer.Stream.Serialize(&p->GridSize);
        serializer.Stream.Serialize(&p->LastUpdateTick);
        QBoolean.Serialize(&p->IsValid, serializer);
        FP.Serialize(&p->CellSize, serializer);
        FPVector3.Serialize(&p->GridOrigin, serializer);
  ...
  public unsafe partial struct Player : Quantum.IComponent {
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 2621;
        hash = hash * 31 + CoinsCollected.GetHashCode();
        hash = hash * 31 + ShootCooldownTimer.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (Player*)ptr;
        serializer.Stream.Serialize(&p->CoinsCollected);
        FP.Serialize(&p->ShootCooldownTimer, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  public unsafe partial class Frame {
    ...
    partial void InitGen() {
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.FlowFieldData>();
      BuildSignalsArrayOnComponentRemoved<Quantum.FlowFieldData>();
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.FlowFieldData), Quantum.FlowFieldData.SIZE);
    ...
    static partial void InitComponentTypeIdGen() {
      ComponentTypeId.Reset(ComponentTypeId.BuiltInComponentCount + 9)
        ...
        .Add<Quantum.FlowFieldData>(Quantum.FlowFieldData.Serialize, null, null, ComponentFlags.Singleton)
